    ...
    public class DataEnMemoria : IDataEnMemoria
    {
        ...
        public DataEnMemoria()
        {
            _charts = new List<Entidades.Chart>()
            {
                ...
                new Entidades.Chart(){Id=1,Type="pie",Label="Coca",Data=new int[]{100,152,351,100,57},Colores=new string[]{"rgb(47, 141, 22,0.5 )", "rgb(63, 95, 133  )", "rgb(97, 32, 85 ,0.4 )", "rgb(33, 31, 49 ,0.6 )" },Labels=new string[]{"Azucar","Agua","Sodio","Carboidratos","Conservantes" } },
                ...
                new Entidades.Chart(){Id=1,Type="radar",Label="Messi",Data=new int[]{100,98,175,75,33},Colores=new string[]{ "rgb(144, 108, 22 )", "rgb(47, 100, 22,0.5 )", "rgb(63, 95, 100,0.4  )", "rgb(97, 32, 85 ,0.4 )", "rgb(33, 31, 49 ,0.6 )" },Labels=new string[]{"Velocidad","Agilidad","Altura","Dinero en millones","Edad" } },
                 new Entidades.Chart(){Id=1,Type="line",Label="Cadena",Data=new int[]{100,-98,175,75,-33},Colores=new string[]{ "rgb(200, 108, 87,0.7 )", "rgb(47, 100, 22,0.5 )", "rgb(63, 95, 100,0.4  )", "rgb(56, 115, 85 ,0.7 )", "rgb(33, 31, 49 ,0.6 )" },Labels=new string[]{"Dureza","Martensita","Hierro","Eslabones","Tenacidad" } }
            };
